  ...
  ((e = (function () {
    ...
    return function (t, o) {
      ...
      (n.defaults = {
        ...
        asNavFor: null,
        prevArrow:
          '<div class="slick-arrows"><button class="slick-prev"  type="button"><i class="fa fa-arrow-left"></i></button></div>',
        nextArrow:
          '<div class="slick-arrows"><button class="slick-next"  type="button"><i class="fa fa-arrow-right"></i></button></div>',
        autoplay: !1,
        autoplaySpeed: 3e3,
        centerMode: !1,
        centerPadding: "50px",
